...
--
-- Table structure for table `tabela_contas`
--

DROP TABLE IF EXISTS `tabela_contas`;
...
CREATE TABLE `tabela_contas` (
  ...
  `saldo_conta` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id_cliente`,`id_conta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tabela_contas`
--

LOCK TABLES `tabela_contas` WRITE;
/*!40000 ALTER TABLE `tabela_contas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tabela_contas` ENABLE KEYS */;
UNLOCK TABLES;
